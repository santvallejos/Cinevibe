...
<main class="relative z-20 flex-grow flex items-center justify-center px-6 py-12 lg:py-24">
        <div
            class="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-12 gap-0 overflow-hidden rounded-xl shadow-2xl bg-surface-container-low/40">
            <!-- Left Editorial Section -->
            <div class="hidden lg:flex lg:col-span-7 flex-col justify-between p-12 relative overflow-hidden">
                <div class="relative z-10">
                    <h1
                        class="text-secondary-fixed-dim font-headline text-lg font-bold tracking-[0.2em] mb-4 uppercase">
                        CINEVIBE</h1>
                ...
                <div class="relative z-10 flex items-center space-x-6">
                    <div class="flex -space-x-3">
                        <img alt="" class="w-10 h-10 rounded-full border-2 border-surface"
                ...
                <div class="absolute -top-24 -left-24 w-96 h-96 bg-secondary-fixed-dim/10 blur-[120px] rounded-full">
                </div>
            </div>
            ...
            <div class="lg:col-span-5 glass-panel p-8 md:p-12 border-l border-white/5">
                <div class="mb-10 text-center lg:text-left">
                    <div class="lg:hidden mb-6">
                        <span
                            class="text-secondary-fixed-dim font-headline text-2xl font-black tracking-widest">CINEVIBE</span>
                    </div>
                ...
                <form class="space-y-8">
                    ...
                    <div class="group relative">
                        <label
                            class="block text-xs font-semibold text-secondary-fixed-dim uppercase tracking-widest mb-2 transition-all group-focus-within:text-secondary-fixed-dim/80"
                            for="email">Correo Electrónico</label>
                        <div class="relative">
                            <input
                                class="w-full bg-surface-container-lowest/50 border-0 border-b-2 border-outline-variant/30 py-3 px-0 text-on-surface focus:ring-0 focus:border-secondary-fixed-dim transition-all placeholder:text-neutral-600 font-medium"
                                id="email" placeholder="name@luxury.com" type="email" />
                            <span
                                class="material-symbols-outlined absolute right-0 top-3 text-neutral-600 text-sm">alternate_email</span>
                        </div>
                    </div>
                    <!-- Password Input -->
                    <div class="group relative">
                        <div class="flex justify-between items-end mb-2">
                            <label
                                class="block text-xs font-semibold text-secondary-fixed-dim uppercase tracking-widest transition-all group-focus-within:text-secondary-fixed-dim/80"
                                for="password">Contraseña</label>
                            <a class="text-[10px] text-neutral-500 hover:text-on-surface transition-colors uppercase tracking-tighter"
                        ...
                        <div class="relative">
                            ...
                            <span
                                class="material-symbols-outlined absolute right-0 top-3 text-neutral-600 text-sm">lock</span>
                        </div>
                    </div>
                    <!-- Submit Action -->
                    <div class="pt-4">
                        <button
                            class="w-full py-4 bg-gradient-to-br from-secondary-fixed-dim to-[#b89600] text-on-secondary font-headline font-extrabold uppercase tracking-widest rounded-full shadow-lg shadow-secondary-fixed-dim/20 hover:shadow-secondary-fixed-dim/40 transform hover:-translate-y-0.5 transition-all active:scale-[0.98]"
                            type="submit">
                            Iniciar Sesión
                        </button>
                    </div>
                ...
                <div class="mt-12 text-center">
                    <p class="text-neutral-500 text-sm">
                        ...
                        <a class="text-on-surface font-bold ml-1 hover:text-secondary-fixed-dim transition-colors underline underline-offset-4 decoration-secondary-fixed-dim/30"
                            <a href="{{ route('register.index') }}">REGISTRATE</a>
                    </p>
                </div>
                <!-- Social Access -->
                <div class="mt-10 pt-10 border-t border-white/5 flex flex-col items-center">
                    ...
                    <div class="flex space-x-6">
                        <button
                            class="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-white/5 transition-colors group">
                            <span
                                class="material-symbols-outlined text-neutral-400 group-hover:text-on-surface">google</span>
                        </button>
                        <button
                            class="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-white/5 transition-colors group">
                            <span
                                class="material-symbols-outlined text-neutral-400 group-hover:text-on-surface">ios</span>
                        </button>
                    </div>
                </div>
            </div>
