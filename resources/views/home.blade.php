...
@section('content')
    <main class="pt-0">
        ...
        <section class="relative h-[972px] w-full flex items-end overflow-hidden">
            <div class="absolute inset-0 z-0">
                <img class="w-full h-full object-cover object-center"
                    data-alt="Cinematic wide shot of a dark science fiction landscape with dramatic red lighting and floating monolithic structures in a misty atmosphere"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuAyZbEEPP81WTUokuXxBZBaL7ygSj-YSoCBNNGzrJz8OSgCQ67nk_5NQa0iVb0xx0heUYjjpvU95oSKAtHUTe1GIrjcTHXWT9sXWly4UUVrEE7f-CDSSpC91GIQKdyvTJPV4p6hf-HCCPvu4Y0jM69ebUF1zheFYuw3PURHpNI12Xlx8i6E2w1GwjqfuqkYAH63AvZuXwASgxxEkyiHH-ZnSEr3ySih_XshMg-qjbZeSluiMQqi2jKRFmqem7qf0do_CPSFWYQGirSi"
                    style="">
            ...
            <div class="container mx-auto px-8 pb-24 z-10">
                <div class="max-w-3xl space-y-6">
                    <div class="flex items-center gap-3">
                        <span
                            class="bg-secondary-container text-on-secondary-container px-3 py-1 rounded-lg text-xs font-bold uppercase tracking-widest"
                            style="">Premiere</span>
                        <span class="text-on-surface-variant text-sm font-medium" style="">Science Fiction • 2h
                            45m</span>
                    </div>
                    <h1 class="text-7xl md:text-8xl font-headline font-extrabold tracking-tighter text-on-surface"
                        style="">NEBULA<br>PROTOCOL</h1>
                    <p class="text-xl text-on-surface-variant max-w-xl leading-relaxed" style="">
                        In a future where stars go silent, one crew must venture into the void to restart the engine of
                        existence. Experience the cinematic event of the decade.
                    </p>
                    <div class="flex items-center gap-4 pt-4">
                        <button
                            class="bg-gradient-to-br from-primary to-primary-container text-on-primary-container px-10 py-4 rounded-full font-bold uppercase tracking-widest text-sm flex items-center gap-2 hover:shadow-[0_0_30px_rgba(229,9,20,0.5)] transition-all"
                            style="">
                        ...
                        <button
                            class="bg-surface-container-highest/50 backdrop-blur-md text-on-surface border border-outline-variant/20 px-10 py-4 rounded-full font-bold uppercase tracking-widest text-sm hover:bg-surface-bright transition-all"
                            style="">
                            Book Tickets
                        </button>
                    </div>
        ...
        <section class="py-24 bg-surface px-8">
            <div class="container mx-auto">
                <div class="flex justify-between items-end mb-12">
                    <div class="space-y-2">
                        <span class="text-primary font-bold tracking-widest uppercase text-sm" style="">Live
                            Experience</span>
                        <h2 class="text-4xl font-headline font-bold" style="">Now Showing</h2>
                    </div>
                    <div class="flex gap-4">
                        <button
                            class="p-3 rounded-full border border-outline-variant/20 hover:bg-surface-container-high transition-colors"
                            style="">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    <!-- Movie Card 1 -->
                    <div
                        class="group relative bg-surface-container rounded-xl overflow-hidden transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl">
                        ...
                        <div
                            class="absolute top-4 right-4 bg-surface-container-lowest/80 backdrop-blur-md px-3 py-1 rounded-lg">
                            <span class="text-secondary font-bold text-sm" style="">★ 8.9</span>
                        </div>
                        <div class="absolute bottom-0 left-0 right-0 p-6 space-y-4">
                            <div>
                                <h3 class="text-xl font-bold font-headline leading-tight" style="">Shadow of the
                                    City</h3>
                            ...
                            <div class="flex justify-between items-center pt-2">
                                ...
                                <button
                                    class="bg-primary-container text-on-primary-container px-5 py-2 rounded-full text-xs font-bold uppercase tracking-wider hover:bg-primary transition-colors"
                    ...
                    <div
                        ...
                        <div class="absolute bottom-0 left-0 right-0 p-6 space-y-4">
                            <div>
                                <h3 class="text-xl font-bold font-headline leading-tight" style="">The Last
                                    Horizon</h3>
                    ...
                    <div
                        ...
                        <div class="absolute bottom-0 left-0 right-0 p-6 space-y-4">
                            <div>
                                <h3 class="text-xl font-bold font-headline leading-tight" style="">Velvet
                                    Dynasty</h3>
                    ...
                    <div
                        ...
                        <div class="absolute bottom-0 left-0 right-0 p-6 space-y-4">
                            <div>
                                <h3 class="text-xl font-bold font-headline leading-tight" style="">Silence
                                    Speaks</h3>
        ...
        <section class="py-12 px-8">
            <div class="container mx-auto">
                <div
                    class="relative bg-gradient-to-r from-surface-container-low to-surface-container-high rounded-[2rem] p-12 overflow-hidden flex flex-col md:flex-row items-center gap-12 group">
                    <div
                        class="absolute top-0 right-0 w-1/3 h-full opacity-10 pointer-events-none group-hover:opacity-20 transition-opacity">
                        <span class="material-symbols-outlined text-[300px] absolute -right-20 -top-20"
                    ...
                    <div class="relative z-10 space-y-6 flex-1 text-center md:text-left">
                        <h2 class="text-4xl md:text-5xl font-headline font-black tracking-tight leading-tight"
                            style="">Join THE VELVET CLUB</h2>
                        <p class="text-on-surface-variant text-lg max-w-lg" style="">Get 20% off all bookings,
                            exclusive premiere invites, and complimentary popcorn on every visit. The ultimate cinematic
                            lifestyle awaits.</p>
                        <div class="flex flex-wrap justify-center md:justify-start gap-4 pt-4">
                            <button
                                class="bg-secondary-container text-on-secondary-container px-10 py-4 rounded-full font-bold uppercase tracking-widest text-sm hover:scale-105 active:scale-95 transition-all"
                                style="">Become a Member</button>
                            <button
                                class="text-on-surface font-bold text-sm uppercase tracking-widest flex items-center gap-2 hover:gap-4 transition-all"
                                style="">
                                Learn More
                    ...
                    <div class="relative z-10 w-full max-w-sm">
                        <div
                            class="bg-surface-bright/40 backdrop-blur-xl border border-outline-variant/30 p-8 rounded-3xl shadow-2xl rotate-3 group-hover:rotate-0 transition-transform duration-500">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="pt-8 flex justify-between items-end">
                                    <span class="font-headline font-bold text-lg tracking-widest"
                                        style="">PREMIUM PASS</span>
                                    <div class="text-right">
                                        <div class="text-[10px] uppercase opacity-50" style="">Member Since
                                        </div>
                    ...
                    <div class="min-w-[400px] snap-start group cursor-pointer">
                        <div class="relative aspect-video rounded-2xl overflow-hidden mb-6">
                            <img class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105"
                                ...
                                style="">
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-surface-container-lowest to-transparent opacity-60">
                            </div>
                            <div class="absolute bottom-4 left-4">
                                <span
                                    class="bg-primary-container/20 backdrop-blur-md text-primary-fixed border border-primary-container/30 px-3 py-1 rounded text-[10px] font-bold uppercase tracking-tighter"
                                    style="">Dec 15</span>
                            </div>
                        </div>
                        <h3 class="text-xl font-bold font-headline group-hover:text-primary transition-colors"
                            style="">Velocity: Drift Protocol</h3>
